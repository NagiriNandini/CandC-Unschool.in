    ...
    while(n--)
    {
        ...
        switch(in)
		{
		    case 11 : 
			{
		        ...
		        scanf("%d", &qty);
		        getchar();
		        p[order_count].number_of_food +=qty;
		        if(i==1) 
				{
					p[order_count].cost += (130*qty);
		        }
		        else 
				{
					p[order_count].cost += (180*qty);
		        	break;
		    	}
			}
		    case 12 :
			{
		        ...
		        if(i==1)
				{
					p[order_count].cost += (750*qty);
		      	}
		        else if(i==2)
				{
				 	p[order_count].cost += (975*qty);
				}
		        else 
				{
					p[order_count].cost += (1250*qty);
		      	}
		        break;
		    }
		    case 13 :
			{
		        ...
		        if(i==1) 
				{
					p[order_count].cost += (85*qty);
				}
		        else if(i==2)
				{
					p[order_count].cost += (320*qty);
				}
		        else 
				{
					p[order_count].cost += (790*qty);
		        	break;
		        }
		    }
		    case 14 :
			{
		        ...
		        if(i==1) 
				{
					p[order_count].cost += (70*qty);
				}
		        else if(i==2) 
				{
					p[order_count].cost += (140*qty);
				}
		        else  
				{
					p[order_count].cost += (250*qty);
					break;
				}
		    }
		    case 15 :
		    ...
		    case 16 :
			{
		        ...
		        if(i==1) 
				{
					p[order_count].cost += (120*qty);
				}
		        else 
				{
					p[order_count].cost += (240*qty);
		       		break;
		    	}
		    }
		    case 17 : 
		    ...
		    case 20 :
			{
		        ...
		        if(i==1) 
				{
					p[order_count].cost += (20*qty);
			  	}
		        else
				{
				 	p[order_count].cost += (30*qty);
		        	break;
		        }
		    }
		    default : 
...
int main()
{
	...
	while(1)
	{
        ...
        switch(op)
		{
            ...
            case 4 : 
			{
               printf("Thanks for visiting.Hope you had good experience\n");
               return 0;
        }
    }
}
